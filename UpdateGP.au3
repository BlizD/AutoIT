...
$StrokaZapuska=chr(34) & "c:\Program Files (x86)\1cv82\common\1cestart.exe" & chr(34) & " ENTERPRISE /S a05-sql\upp82 /N UpdateGP /P updateday /RunModeOrdinaryApplication /Execute" & chr(34) & $Path & "UpdateGP.epf" & chr(34)
...
Func SendMail($Text,$ToAddress)
	...
	$FromName = "UpdateGP"                      ; name from who the email was sent
