...
;~ 	$MyTask_Checkbox=GUICtrlCreateCheckbox ("Мои задачи", 90, 2 )
...
Func SQL_Open()
	...
	WEnd
;~ 	ConsoleWrite("База открыта :" & $SQL_TaskDB &@CRLF)
...
;~ 	ConsoleWrite($TextQuery & @CRLF)
	ExecuteQuery($TextQuery)
	;"Insert into Events values (NULL,1,2,'01.01.2011','Новая задача: Тестирование SQL',0,'BlizzardAnton@mail.ru',0)"
EndFunc
Func Minimize()
;~ 	ConsoleWrite("test")
