...
Func Example()
	Local $msg,$ToAddress
	GUICreate("Список покупок",220,100) ; will create a dialog box that when displayed is centered
...
;~ 	GUICtrlSetOnEvent ($TextSMS, "ChangeLabel")
	...
	$Button_1 = GUICtrlCreateButton("Отправить ", 10, 70, 185,22)
...
Func SendSMS()
	...
	if StringLen($Text)>0 Then
		...
		GUICtrlSetData ($Button_1, "Отправка ...")
		SendMail($Text,$ToAddress)
		GUICtrlSetData ($Button_1, "Сообщение успешно отправлено")
		Sleep(2000)
 		Close()
	EndIf
EndFunc
